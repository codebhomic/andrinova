...
const servicesList = [
  {
    ...
    btnBg: "bg-[#FF6A00] hover:bg-[#e65f00]",
    icon: (
      <svg className="w-20 h-20 stroke-white fill-none stroke-[1.8]" viewBox="0 0 100 100">
        <rect x="25" y="20" width="50" height="60" rx="6" />
        <line x1="25" y1="62" x2="75" y2="62" />
        <rect x="42" y="30" width="16" height="24" rx="2" />
  ...
  },
  {
    ...
    btnBg: "bg-[#2D0B6B] hover:bg-[#200650]",
    icon: (
      <svg className="w-20 h-20 stroke-white fill-none stroke-[1.8]" viewBox="0 0 100 100">
        <rect x="20" y="20" width="60" height="60" rx="4" />
        <line x1="20" y1="70" x2="80" y2="70" />
        <line x1="20" y1="44" x2="80" y2="44" />
        <rect x="46" y="34" width="8" height="10" fill="white" />
  ...
  },
  {
    ...
    icon: (
      <svg className="w-20 h-20 stroke-white fill-none stroke-[1.8]" viewBox="0 0 100 100">
        <rect x="24" y="22" width="52" height="10" rx="2" />
        <polygon points="40,32 60,32 53,48 47,48" fill="white" />
        <line x1="50" y1="48" x2="50" y2="64" strokeDasharray="2 2" strokeWidth="2" />
        <polygon points="20,70 80,70 66,82 34,82" />
        <path d="M44 60 Q50 56 56 60" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-20 h-20 stroke-white fill-none stroke-[1.8]" viewBox="0 0 100 100">
        <path d="M20 25 L35 25 L45 45 L50 45 L50 55" strokeWidth="2.2" />
  ...
  },
  {
    ...
    icon: (
      <svg className="w-20 h-20 stroke-white fill-none stroke-[1.8]" viewBox="0 0 100 100">
        ...
        <path d="M28 35 L45 35 L55 45 L72 45" strokeWidth="2.2" />
        <circle cx="72" cy="45" r="3" fill="white" />
        <circle cx="28" cy="65" r="3" fill="white" />
        <path d="M28 65 L48 65 L60 55 L72 55" strokeWidth="2.2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {servicesList.map((srv) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col justify-between flex-1 pr-4">
                  ...
                  <div>
                    <button 
                      ...
                      className={`${srv.btnBg} text-white text-xs font-bold py-2.5 px-6 rounded-lg transition-colors cursor-pointer shadow-xs`}
                    >
                      Order Now
                    </button>
                  </div>
                ...
                {/* Right: Orange Illustration Container */}
